...
using AR.XFSample.Droid.Renderings;

namespace AR.XFSample.Droid.Helpers
{
    [Activity(Theme = "@style/Theme.AppCompat.NoActionBar", ConfigurationChanges = Android.Content.PM.ConfigChanges.Orientation| Android.Content.PM.ConfigChanges.ScreenSize, ScreenOrientation = Android.Content.PM.ScreenOrientation.Locked)]
    public class ArActivityHelper : AppCompatActivity, GLSurfaceView.IRenderer, Android.Views.View.IOnTouchListener
    {
        const string TAG = "ArActivityHelper";
        ...
        public void OnSurfaceCreated(IGL10 gl, Javax.Microedition.Khronos.Egl.EGLConfig config)
        {
            ...
            {
                Toast.MakeText(this, "Failed to read obj file", ToastLength.Long).Show();
